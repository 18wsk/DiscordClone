...
const ProfileLink = () => {
    ...
    return (
        <div className="w-full h-full flex flex-cols-2 items-center justify-center gap-x-4 px-2 bg-slate-100">
            ...
            <div className="w-full h-full flex flex-col items-top justify-center">
                <h1 className="text-start text-lg font-extrabold text-black">{user?.userName}</h1>
            </div>
        </div>
    );
}
