...
const ProfileLink = () => {
    ...
    return (
        <div className="w-[300px] h-full flex xs:flex-rows-2 xs:flex-col md:flex-row md:flex-cols-2 items-center justify-center gap-x-4 px-2 bg-tertiary " onClick={() => setActiveThread(null)}>
